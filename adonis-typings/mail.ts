...
declare module '@ioc:Adonis/Addons/Mail' {
  ...
  */
  ...
  export interface SmtpDriverContract extends MailDriverContract {
    send(
      message: MessageNode,
      metaOptions?: SmtpConfigContract['meta']
  ...
  |--------------------------------------------------------------------------
  |
  | Interfaces and types for the Mailgun Driver
  |
  */
   ...
   */
  export type MailgunConfigContract = BaseConfigContract & {
    /*
     * Domain name to build the api url
     */
    domain: string;
    /**
     * Authentication
    ...
    apiKey: string;
    /*
     * Hostname to build the api url, default will be: api.mailgun.net
     */
    hostname?: string;
   ...
   */
  export type MailgunMailResponse = {
    messageId: string,
  ...
  export interface MailgunDriverContract extends MailDriverContract {
    send(
      message: MessageNode,
      metaOptions?: SmtpConfigContract['meta']
    ): Promise<MailgunMailResponse>;
  }

  /**
   * Shape of the mailer
   */
  export interface MailManagerContract<DefaultDriver = MailDriverContract>
