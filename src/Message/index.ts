...
export class Message implements MessageContract {
	...
	/**
	 * Content for the message. Generated by rendering views
	 * or has been set directly
	 */
	public content: {
		html?: string
		text?: string
	...
	public htmlView(template: string, data?: any): this {
		...
		this.contentViews.html = template
		return this
	}
	...
	public textView(template: string, data?: any): this {
		...
		this.contentViews.text = template
		return this
	}
	...
	public watchView(template: string, data?: any): this {
		...
		this.contentViews.watch = template
		return this
	}
